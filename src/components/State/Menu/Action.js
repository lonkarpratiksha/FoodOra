...
export const getMenuItemByRestaurantId= (reqData)=>{
    return async (dispatch)=>{
        ...
        try{
            const {data} = await api.get(`/api/food/restaurant/${reqData.restaurantId}?vegetarian=${reqData.vegetarian}&seasonal=${reqData.seasonal}&nonveg=${reqData.nonveg}&food_category=${reqData.foodCategory}`,{
                headers: {
...
export const updateMenuUpdateAvailability = ({foodId,jwt}) =>{
    return async (dispatch)=> {
